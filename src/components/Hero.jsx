            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10 w-full">
                ...
                >
                    ...
                    <div className="flex gap-6 mt-12 text-3xl text-secondary">
                        ...
                        <a href="mailto:anjalivarshney405@gmail.com?subject=Portfolio%20Inquiry&body=Hello%20Anjali," className="hover:text-neonBlue transition-colors transform hover:scale-110">
                            <AiOutlineMail />
                        </a>
                    </div>
